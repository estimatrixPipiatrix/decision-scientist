...
\title[Navigating Success]{Navigating Success: A Decision Intelligence Journey for a Shipping Company} % The short title in the optional parameter appears at the bottom of every slide, the full title in the main parameter is only on the title page
